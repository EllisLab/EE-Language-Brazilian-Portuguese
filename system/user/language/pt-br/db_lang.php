...
'db_batch_missing_index' => 'Uma ou mais linhas enviadas para atualização em lote não se encontra no índice especificado.',
...
'db_field_param_missing' => 'Para pegar os campos, é necessário o nome da tabela como um parâmetro.',

'db_filepath_error' => 'Não foi possível gravar os dados no arquivo, no caminho que você forneceu.',
...
'db_unable_to_connect' => 'Não foi possível conectar o banco de dados do servidor utilizando as configurações fornecidas.',

'db_unable_to_create' => 'Não foi possível criar o banco de dados especificado: %s',

'db_unable_to_drop' => 'Não foi possível dropar o banco de dados especificado.',

'db_unable_to_select' => 'Não foi possível selecionar o banco de dados especificado: %s',

'db_unable_to_set_charset' => 'Não foi possível definir o conjunto de caracteres de conexão ao cliente: %s',

'db_unsuported_compression' => 'O formato de compressão de arquivo que você escolheu não é suportado pelo seu servidor.',

'db_unsuported_feature' => 'Recurso não-suportado pela plataforma do banco de dados que você está usando.',

'db_unsupported_function' => 'Este recurso não está disponível para o banco de dados que você está usando.',
