...
'rel_ft_authors' => 'Autores',

'rel_ft_authors_desc' => 'Selecione os autores para limitar as publicações neste campo de itens relacionados.',

'rel_ft_categories' => 'Limitar por categoria',

'rel_ft_categories_desc' => 'Escolha as categorias para limitar as publicações neste campo de itens relacionados.',
...
'rel_ft_include_desc' => 'Permitir publicações expiradas ou futuras neste campo de itens relacionados.',

'rel_ft_include_expired' => 'Publicações Expiradas',

'rel_ft_include_future' => 'Publicações Futuras',
...
'rel_ft_order_ascending' => 'Alfabética (A-Z)',

'rel_ft_order_date' => 'Data da Publicação',

'rel_ft_order_desc' => 'Ordem Padrão das publicações no campo de itens relacionados.',

'rel_ft_order_descending' => 'Alfabética Inversa (Z-A)',

'rel_ft_order_title' => 'Título',

'rel_ft_related_only' => 'Apenas Relacionados',

'rel_ft_statuses' => 'Limitar por status',

'rel_ft_statuses_desc' => 'Selecione os status para limitar as publicações neste campo de itens relacionados.',

'rel_ft_unrelated_only' => 'Apenas Não Relacionados',
...
'file_ft_allowed_dirs_desc' => 'Pasta Padrão para armazenar os arquivos subidos neste campo.',

'file_ft_cannot_find_file' => '<b>Arquivo não encontrado.</b> Não conseguimos localizar %s no servidor.',

'file_ft_configure' => 'Opções Gerais de Campo',

'file_ft_configure_subtext' => 'Tenha um controle maior sobre como o campo de arquivo deve se comportar.',
...
'grid_col_width' => 'Largura mínima da coluna',

'grid_col_width_desc' => 'Defina a largura mínima (em pixels) desta coluna no formulário de publicação.',
...
'grid_reorder_field' => 'reordenar campo',
...
'url_ft_invalid_url' => 'URL Inválida',
